  ...
  return (
    <>
      ...
      <div className="space-y-5">
        ...
        {semDadosGlobal && !carregando && (
          <div className="rounded-lg border border-dashed border-amber-300 bg-amber-50 px-4 py-3 text-xs text-amber-800 dark:border-amber-700 dark:bg-amber-900/10 dark:text-amber-300">
        ...
        {!carregando && ultimaCompetencia && (
          <p className="flex items-center gap-1.5 px-1 text-xs text-gray-400 dark:text-gray-500">
        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
          {carregando
            ...
            : [
                ...[...contagemPorTipo].sort((a, b) => (b.criticos - a.criticos) || (b.altos - a.altos)).map((t) => {
                ...
                />,
                <CardEmBreve
                  key="familias-municipio"
                  titulo="Famílias por município"
                  descricao="Cadastradas, em pobreza e beneficiárias"
