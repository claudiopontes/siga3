...
import EtlStatusClient from "@/components/seguranca/EtlStatusClient";

export const metadata: Metadata = {
  title: "Segurança | Status das Bases ETL",
  description: "Monitoramento das últimas execuções dos jobs ETL",
};
