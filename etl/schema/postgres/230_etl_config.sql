...
VALUES
  ...
  ('mart_remessas', 'Remessas Contábeis', 'diaria', 1, true, NULL, 9),
  ('remessas_full_postgres', 'Carga Remessas', 'mensal', 30, false, NULL, 10),
  ('remessas_dimensoes_postgres', 'Dimensões Remessas', 'diaria', 1, false, NULL, 10),
